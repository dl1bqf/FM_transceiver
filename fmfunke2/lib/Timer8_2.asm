...
;  Global Symbols
;-----------------------------------------------
export  Timer8_2_EnableInt
export _Timer8_2_EnableInt
export  Timer8_2_DisableInt
export _Timer8_2_DisableInt
export  Timer8_2_Start
export _Timer8_2_Start
export  Timer8_2_Stop
export _Timer8_2_Stop
export  Timer8_2_WritePeriod
export _Timer8_2_WritePeriod
export  Timer8_2_WriteCompareValue
export _Timer8_2_WriteCompareValue
export  Timer8_2_bReadCompareValue
export _Timer8_2_bReadCompareValue
export  Timer8_2_bReadTimer
export _Timer8_2_bReadTimer
export  Timer8_2_bReadTimerSaveCV
export _Timer8_2_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTimer8_2_ReadCompareValue  ; deprecated
export _bTimer8_2_ReadCompareValue  ; deprecated
export  bTimer8_2_ReadTimer         ; deprecated
export _bTimer8_2_ReadTimer         ; deprecated
export  bTimer8_2_ReadTimerSaveCV   ; deprecated
export _bTimer8_2_ReadTimerSaveCV   ; deprecated

export  bTimer8_2_ReadCounter       ; obsolete
export _bTimer8_2_ReadCounter       ; obsolete
export  bTimer8_2_CaptureCounter    ; obsolete
export _bTimer8_2_CaptureCounter    ; obsolete


AREA fmfunke_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_2_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_2_DisableInt
;
;  DESCRIPTION:
...
;
 Timer8_2_DisableInt:
_Timer8_2_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8_2_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_2_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8_2_WritePeriod:
_Timer8_2_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8_2_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer8_2_WriteCompareValue:
_Timer8_2_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8_2_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_2_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8_2_bReadCompareValue:
_Timer8_2_bReadCompareValue:
 bTimer8_2_ReadCompareValue:                     ; this name deprecated
_bTimer8_2_ReadCompareValue:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8_2_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_2_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer8_2_bReadTimerSaveCV:
_Timer8_2_bReadTimerSaveCV:
 bTimer8_2_ReadTimerSaveCV:                      ; this name deprecated
_bTimer8_2_ReadTimerSaveCV:                      ; this name deprecated
 bTimer8_2_ReadCounter:                          ; this name deprecated
_bTimer8_2_ReadCounter:                          ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[Timer8_2_CONTROL_REG]            ; save the Control register
   push  A
   mov   A, reg[Timer8_2_COMPARE_REG]            ; save the Compare register
   push  A
   mov   A, reg[Timer8_2_COUNTER_REG]            ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8_2_COMPARE_REG]            ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_2_bReadTimer
;
;  DESCRIPTION:
...
;
 Timer8_2_bReadTimer:
_Timer8_2_bReadTimer:
 bTimer8_2_ReadTimer:                            ; this name deprecated
_bTimer8_2_ReadTimer:                            ; this name deprecated
 bTimer8_2_CaptureCounter:                       ; this name deprecated
_bTimer8_2_CaptureCounter:                       ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8_2_COUNTER_REG]            ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8_2_COMPARE_REG]            ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File Timer8_2.asm
