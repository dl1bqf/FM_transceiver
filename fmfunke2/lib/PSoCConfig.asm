...
export LoadConfig_fmfunke
export _LoadConfig_fmfunke
...
;---------------------------------------------------------------------------
; Load Configuration fmfunke
;
;    Load configuration registers for fmfunke.
...
_LoadConfig_fmfunke:
 LoadConfig_fmfunke:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_fmfunke_Bank0
    mov     X, <LoadConfigTBL_fmfunke_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_fmfunke_Bank1
    mov     X, <LoadConfigTBL_fmfunke_Bank1
