...
;  Global Symbols
;-----------------------------------------------
export  Timer8_3_EnableInt
export _Timer8_3_EnableInt
export  Timer8_3_DisableInt
export _Timer8_3_DisableInt
export  Timer8_3_Start
export _Timer8_3_Start
export  Timer8_3_Stop
export _Timer8_3_Stop
export  Timer8_3_WritePeriod
export _Timer8_3_WritePeriod
export  Timer8_3_WriteCompareValue
export _Timer8_3_WriteCompareValue
export  Timer8_3_bReadCompareValue
export _Timer8_3_bReadCompareValue
export  Timer8_3_bReadTimer
export _Timer8_3_bReadTimer
export  Timer8_3_bReadTimerSaveCV
export _Timer8_3_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTimer8_3_ReadCompareValue  ; deprecated
export _bTimer8_3_ReadCompareValue  ; deprecated
export  bTimer8_3_ReadTimer         ; deprecated
export _bTimer8_3_ReadTimer         ; deprecated
export  bTimer8_3_ReadTimerSaveCV   ; deprecated
export _bTimer8_3_ReadTimerSaveCV   ; deprecated

export  bTimer8_3_ReadCounter       ; obsolete
export _bTimer8_3_ReadCounter       ; obsolete
export  bTimer8_3_CaptureCounter    ; obsolete
export _bTimer8_3_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_3_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_3_DisableInt
;
;  DESCRIPTION:
...
;
 Timer8_3_DisableInt:
_Timer8_3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8_3_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_3_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8_3_WritePeriod:
_Timer8_3_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8_3_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer8_3_WriteCompareValue:
_Timer8_3_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8_3_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_3_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8_3_bReadCompareValue:
_Timer8_3_bReadCompareValue:
 bTimer8_3_ReadCompareValue:                     ; this name deprecated
_bTimer8_3_ReadCompareValue:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8_3_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_3_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer8_3_bReadTimerSaveCV:
_Timer8_3_bReadTimerSaveCV:
 bTimer8_3_ReadTimerSaveCV:                      ; this name deprecated
_bTimer8_3_ReadTimerSaveCV:                      ; this name deprecated
 bTimer8_3_ReadCounter:                          ; this name deprecated
_bTimer8_3_ReadCounter:                          ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[Timer8_3_CONTROL_REG]            ; save the Control register
   push  A
   mov   A, reg[Timer8_3_COMPARE_REG]            ; save the Compare register
   push  A
   mov   A, reg[Timer8_3_COUNTER_REG]            ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8_3_COMPARE_REG]            ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8_3_bReadTimer
;
;  DESCRIPTION:
...
;
 Timer8_3_bReadTimer:
_Timer8_3_bReadTimer:
 bTimer8_3_ReadTimer:                            ; this name deprecated
_bTimer8_3_ReadTimer:                            ; this name deprecated
 bTimer8_3_CaptureCounter:                       ; this name deprecated
_bTimer8_3_CaptureCounter:                       ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8_3_COUNTER_REG]            ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8_3_COMPARE_REG]            ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File Timer8_3.asm
