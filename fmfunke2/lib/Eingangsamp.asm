...
;  Global Symbols
;-----------------------------------------------
export  Eingangsamp_Start
export _Eingangsamp_Start
export  Eingangsamp_SetPower
export _Eingangsamp_SetPower

export  Eingangsamp_SetGain
export _Eingangsamp_SetGain

export  Eingangsamp_Stop
export _Eingangsamp_Stop

IF (Eingangsamp_AGNDBUFAPI)
export  Eingangsamp_EnableAGNDBuffer
export _Eingangsamp_EnableAGNDBuffer
export  Eingangsamp_DisableAGNDBuffer
export _Eingangsamp_DisableAGNDBuffer
ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Eingangsamp_Start
;  FUNCTION NAME: Eingangsamp_SetPower
;
;  DESCRIPTION:
...
;
 Eingangsamp_Start:
_Eingangsamp_Start:
 Eingangsamp_SetPower:
_Eingangsamp_SetPower:
...
;
   ...
   mov  A, reg[Eingangsamp_GAIN_CR2]                       ; read power value
   and  A, ~POWERMASK                                ; clear power bits in A
   or   A, [X]                                       ; combine power value with balance of reg.
   mov  reg[Eingangsamp_GAIN_CR2], A                  ; move complete value back to register
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Eingangsamp_SetGain
;
;  DESCRIPTION:
...
;
   ...
   mov  A, reg[Eingangsamp_GAIN_CR0]                       ; read mux settings
   and  A, ~GAINREGMASK                                   ; clear gain bits in A
   tst  [X],HIGHGAIN                                      ; See if High Gain is set
   jnz  .SETHIGHGAIN
   and  reg[Eingangsamp_GAIN_CR3],~EXGAIN                  ; Clear High Gain bit.
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[Eingangsamp_GAIN_CR0], A                       ; move complete value back to register
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SETHIGHGAIN:
   ...
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[Eingangsamp_GAIN_CR0], A                       ; move complete value back to register
   or   reg[Eingangsamp_GAIN_CR3], EXGAIN                  ; Set High Gain bit.
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Eingangsamp_Stop
;
;  DESCRIPTION:
...
_Eingangsamp_Stop:
   ...
   and REG[Eingangsamp_GAIN_CR2], ~POWERMASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Eingangsamp_EnableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 Eingangsamp_EnableAGNDBuffer:
_Eingangsamp_EnableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   reg[Eingangsamp_GAIN_CR3], ~AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Eingangsamp_DisableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 Eingangsamp_DisableAGNDBuffer:
_Eingangsamp_DisableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or    reg[Eingangsamp_GAIN_CR3], AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
ENDIF

; End of File Eingangsamp.asm
